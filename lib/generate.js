...
const SUBMIT_CONCURRENCY = IS_VERCEL ? 10 : 20;
const POLL_HINT = { maxAttempts: 60, intervalMs: 3000, fastAttempts: 8, fastIntervalMs: 2000 };
...
async function runPoll(body) {
  ...
  return {
    status: 'completed',
    taskId,
    image: { id: index, seed, size, taskId, dataUrl, fileName }
  };
}
